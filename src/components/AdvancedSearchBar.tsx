...
export default function AdvancedSearchBar({ 
  ...
  const [searchSource, setSearchSource] = useState<'prisma' | 'elasticsearch'>('prisma');
    ...
    <div className={`relative w-full max-w-2xl mx-auto ${className}`}>
      ...
      {query && (
        <div className="absolute top-full left-0 mt-1 text-xs text-gray-500 flex items-center gap-1">
          <div className={`w-2 h-2 rounded-full ${searchSource === 'elasticsearch' ? 'bg-green-500' : 'bg-blue-500'}`}></div>
          Recherche avec {searchSource === 'elasticsearch' ? 'Elasticsearch' : 'Prisma'}
        </div>
      )}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-gray-500 flex items-center gap-2">
                  ...
                  {suggestion.location}
                  {suggestion.type === 'listing' && suggestion.price > 0 && (
                    <>
                      <span>•</span>
